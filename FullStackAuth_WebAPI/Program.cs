...
namespace FullStackAuth_WebAPI
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<RequestInterceptionMiddleware>();
            //builder.Services.AddScoped<ResponseCapturingMiddleware>();
            ...
            app.UseMiddleware<ResponseCapturingMiddleware>();
